/**
 * Estilo "Mostly Grayscale" do Google Maps.
 * Aplicado via prop `styles` no componente Map do @vis.gl/react-google-maps.
 * Não usar em conjunto com mapId — o style cloud-based sobrescreve este array.
 */
export const MAP_STYLE_MOSTLY_GRAYSCALE: google.maps.MapTypeStyle[] = [
  {
